...
/*realiza a consulta no banco de dados usando uma query SQL 
buscando os dados da tabela cliente */
    const result = await
...
routes.put('/', async(req, res) => {
    //recebe todos os valores de cliente V
...
routes.put('/:id', async(req, res) => {
    ...
    const sql = `
    UPDATE cliente
    SET nome = $1, email = $2, telefoone = $3, endereco = $4, cidade = $5, uf = $6
    WHERE id = $7
    RETURNING *
    `;
...
//DELETE (Delete)
// Rota para excluir (Delete) valores no BD
